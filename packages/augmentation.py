from utils import librosa, os, sf, np
from utils import aug_train_data_dir, train_data_dir, ww_aug_train_data_dir, ww_train_data_dir
    ...
    for subdir, dirs, files in os.walk(root_folder):
        for file in files:
            ...
            if file.endswith('.wav'):
                ...
                audio_pitch_scaled = librosa.effects.pitch_shift(
                ...
                new_file_path_with_noise = os.path.join(
                    new_dir, f'noisy_{file}')
                ...
                new_file_path_pitch_scaled = os.path.join(
                    new_dir, f'pitch_scaled_{file}')
